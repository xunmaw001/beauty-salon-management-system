<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="件数" prop="jianshu">
          <el-input v-model="ruleForm.jianshu" 
              placeholder="件数" clearable  :readonly="ro.jianshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="件数" prop="jianshu">
              <el-input v-model="ruleForm.jianshu" 
                placeholder="件数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="消费时间" prop="xiaofeishijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.xiaofeishijian" 
                type="datetime"
                :readonly="ro.xiaofeishijian"
                placeholder="消费时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.xiaofeishijian" label="消费时间" prop="xiaofeishijian">
              <el-input v-model="ruleForm.xiaofeishijian" 
                placeholder="消费时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jine = true;
          ...
          if(o=='xiaofeishijian'){
            this.ruleForm.xiaofeishijian = obj[o];
	    this.ro.xiaofeishijian = true;
            continue;
          }
        }
      }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `yingyejilu/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.yingyejiluCrossAddOrUpdateFlag = false;
						 this.parent.search();
