...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if(`yuangong` == this.tableName && this.ruleForm.jf&&(!this.$validate.isNumber(this.ruleForm.jf))){
        this.$message.error(`积分应输入数字`);
        return
      }
 ...
 //  }
	...
	.container {
		...
		background-repeat: no-repeat;
    				background-image: url(http://codegen.caihongy.cn/20220103/3021798b2c7e44a9a9d12fc808dec7f7.png);
