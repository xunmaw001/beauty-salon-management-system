...
<style lang="scss" scoped>
  ...
  .index-aside {
	...
	.menulist-item {
		...
		background: #fff url("http://codegen.caihongy.cn/20211124/6c16a332d3a247598ce24ca8d7213be6.png") repeat top !important;
		...
		&>.el-menu-item {
			...
			background-color: rgba(252, 195, 194, 1) !important;
		...
		& /deep/ .el-menu.el-menu--inline {
			...
			background-color: rgba(252, 195, 194, 1);
